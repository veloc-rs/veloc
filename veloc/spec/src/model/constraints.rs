...
pub(crate) fn check_property(
    source: &str,
    name: &str,
    nodes: Option<crate::syntax::Node>,
...
pub(crate) fn generate(
    ...
    let params = contexts
        ...
        .collect::<String>();
    let mut out = format!(
        "// @generated by veloc-opgen. Edit the .ops definitions instead.\nimpl Function {{\n    fn validate_constraints(&self, _module: &crate::ModuleData, _inst: Inst, data: &InstView<'_>, _operands: &[Type], _results: &[Type]{params}) -> Result<()> {{\n",
    );
